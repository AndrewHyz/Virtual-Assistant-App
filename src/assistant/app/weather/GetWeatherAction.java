    ...
    System.out.println(req.getUrl());
		try {
		  ...
		  System.out.println(boom);
			...
			assistant.displayItem(new Response("Sorry, I could not connect to the weather service. Please check your internet connection and try again."));
		}
	...
	private static void handleResult(JsonNode node) {
	  ...
	  Assistant assistant = Assistant.getInstance();
		...
		assistant.displayItem(
				new Response("The temperature in " + city + " is " + temp + " degrees Celsius with " + description));
	}
}
